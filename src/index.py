...
url="https://www.gamers-outlet.net/en/xbox/buy-xbox-game-pass-ultimate-3-month-cd-key-xbox-live-global-stackable"
headers = {
...
# target_text=soup.find(class_="product__info").text
# target_text=soup.find_all(string="In Stock")
target_text=soup.get_text()
if target_text!='':
        # print(f'text is :${target_text}')
        pass

if 'In Stock' in target_text:
    print('Found')
